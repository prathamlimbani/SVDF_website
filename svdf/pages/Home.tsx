  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative h-[650px] flex items-center justify-center bg-wood-950 text-white overflow-hidden">
        {/* Background Image - Tree/Wood Texture */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center h-full text-center z-10">
          ...
          <div className="animate-fade-in-up mb-10">
             <img 
               src="/images/logo.png" 
               alt="Sri Vijayalaxmi Doors & Frames"
               className="h-48 md:h-64 w-auto object-contain drop-shadow-2xl mx-auto"
               onError={(e) => {
             ...
             <div id="logo-fallback" className="hidden">
                <h1 className="text-4xl md:text-6xl font-serif font-bold text-amber-500 tracking-wide uppercase drop-shadow-md">
                  Sri Vijayalaxmi
                </h1>
                <h2 className="text-2xl md:text-4xl font-serif font-bold text-wood-100 tracking-widest uppercase mt-2">
                  Doors & Frames
                </h2>
             </div>
          </div>
          
          <div className="animate-fade-in-up delay-75 mb-12">
             <p className="text-amber-200/90 tracking-[0.2em] text-sm md:text-base uppercase font-medium border-t border-b border-amber-500/30 py-4 inline-block">
      ...
      <div className="py-20 px-4 max-w-7xl mx-auto w-full bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <CategoryCard 
            ...
            image="https://images.unsplash.com/photo-1481277542470-60561ff9a458?auto=format&fit=crop&q=80&w=500"
          />
